  ...
  for num_agents_ in ${num_agents[@]}; do
    for seed in $(seq ${seed_max}); do
        ...
        CUDA_VISIBLE_DEVICES=0 python3 train/train_mpe.py --env_name ${env} --algorithm_name ${algo} \
          ...
          --num_landmarks ${num_landmarks_} --seed ${seed} --episode_length 25 --batch_size 32 --tau 0.005 --lr 7e-4 \
          --hard_update_interval_episode 100 --num_env_steps 5000000 \
          --use_same_share_obs --share_hyper_network --use_reward_normalization --use_wandb\
