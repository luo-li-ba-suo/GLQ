...
def get_config():
    ...
    parser.add_argument('--user_name', type=str, default="dujinqi")
    ...
    parser.add_argument("--train_render",
                        action='store_true', default=False)

    # eval parameters
    parser.add_argument('--use_asynchronous_eval', action='store_false',
    ...
    parser.add_argument("--new_proc_eval_render", action='store_false', default=True)
