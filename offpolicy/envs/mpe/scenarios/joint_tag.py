import numpy as np
from offpolicy.envs.mpe.core import World, Agent, Landmark, Action
from offpolicy.envs.mpe.scenario import BaseScenario


def action_callback(agent, world):
    action = Action()
    action.u = np.random.randint(-1, 2, world.dim_p)
...
class Scenario(BaseScenario):
    def make_world(self, args):
        ...
        for i, agent in enumerate(world.agents):
            ...
            agent.action_callback = None if agent.adversary else action_callback
        # add landmarks
    ...
    def reward(self, agent, world):
        ...
        main_reward, separate_rew = self.adversary_reward(agent, world) if agent.adversary else self.agent_reward(agent, world)
        return main_reward, separate_rew
